<?php
    ...
    $query = " SELECT producto.id as id, producto.nombre as nombre, producto.imagen as imagen, producto.descripcion as descripcion FROM producto ";
...
<main class="contenedor">
    ...
    <div class="tienda">
        <img class="tienda__imagen" src="../../portadas/<?php echo $producto['imagen']; ?>" alt="Producto">
